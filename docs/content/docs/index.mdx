...
<Cards>
  <Card title="Zero Dependencies" icon={<Feather />}>
    ...
    performance-critical applications. It uses the standard [Intl.NumberFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat)
    API for formatting operations.
  </Card>
  <Card title="Battle-Tested in Production" icon={<ShieldCheck />}>
    This library is battle-tested in production apps and dashboards, providing
    reliable number formatting and reading for any applications that need process Vietnamese data.
  </Card>
</Cards>
