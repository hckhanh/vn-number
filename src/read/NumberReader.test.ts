...
describe('NumberReader', () => {
  ...
  it('should read number: 1.060.000', () => {
  ...
  it('should read number: 1.001.500.100.000', () => {
  ...
  it('should read number: 1.001.500.100.001', () => {
